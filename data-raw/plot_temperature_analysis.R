...
fls <- dir('~/Dropbox/Sedgwick/spatial_tapioca/data/environmental/ibutton_data/clean/', '.csv$', full.names = T)
...
#
stat_weather <- read.csv('~/Dropbox/Sedgwick/spatial_tapioca/data/environmental/daily_weather_2015_to_2016.csv', sep = ',') 

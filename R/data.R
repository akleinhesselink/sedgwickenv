...
#'   \item{Tmax}{Average daily Tmax (\&degC) temperature for March. Recorded directly with iButton placed in PVC housing on soil surface at each site}
#'   \item{Tmin}{Average daily Tmax (\&degC) temperature for March. Recorded directly with iButton placed in PVC housing on soil surface at each site}
